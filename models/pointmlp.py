...
class Model(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        self.layer_one = self.embedding.net[0]
    ...
    def forward(self, x):
        ...
        batch_size, _, _ = x.size()
        # x = x.permute(0, 2, 1)
        # print("layer_one_out", self.layer_one_out)
        x = self.embedding.net[0](x)  # B,D,N
        self.layer_one_out = x
        self.layer_one_out.requires_grad_()
        self.layer_one_out.retain_grad()
        # print("after", self.layer_one_out)
        x = self.embedding.net[1](x) 
